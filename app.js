...
const POST_DIAG = {
    ...
    chalking_peeling_crazing: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 90, scope: "Complete removal, priming, and application of premium elastomeric anti-carbonation coating.", costDuration: "Moderate | 2 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 75, scope: "Scraping peeled areas, patch priming, and localized painting.", costDuration: "Low | 1 Day" }
    },
    alkali_silica_reactivity: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 92, scope: "Inject cracks with hydrophobic silane/siloxane sealer and apply breathable barrier coating.", costDuration: "Moderate | 3 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 75, scope: "Cosmetic crack sealing with acrylic sealant and exterior weatherproofing paint.", costDuration: "Low | 1 Day" }
    },
    re_wall_collapse: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 95, scope: "Re-excavate backfill, replace reinforcement strip/geogrid, install drainage composite, rebuild panels.", costDuration: "Premium | 7 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 70, scope: "Localized structural panel tie-backs and external pressure grouting.", costDuration: "Moderate | 4 Days" }
    },
    corrosion_minor: {
    ...
    corrosion_spalling_rebar_exposed_moist: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 94, scope: "Expose steel, sandblast, install sacrificial zinc anodes, anti-rust primer, reinstate cover with polymer mortar.", costDuration: "Premium | 3 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 78, scope: "Manual wire-brush rebar cleaning, anti-corrosion slurry paint, and concrete patch plastering.", costDuration: "Moderate | 2 Days" }
    },
    ...
    sulphate_attack: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 92, scope: "Remove weak concrete, patch with Type V cement mortar, apply thick protective polyurethane barrier.", costDuration: "Premium | 4 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 75, scope: "Patch repairs with sulfate-resistant mortars and standard waterproof sealing.", costDuration: "Moderate | 2 Days" }
    },
    flexural_crack_rcc: {
    ...
    scouring: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 93, scope: "Install sheet pile walls, backfill with heavy rock rip-rap/concrete block mattresses.", costDuration: "Premium | 5 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 76, scope: "Fill scour holes with concrete-filled sandbags locally.", costDuration: "Moderate | 2 Days" }
    },
    abrasion_cavitation_concrete_overlay: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 90, scope: "Apply high-strength silica fume concrete overlay or epoxy-resin mortar screed, grind smooth.", costDuration: "Moderate | 3 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 75, scope: "Patch eroded zones locally with high-durability polymer-modified mortar.", costDuration: "Low | 2 Days" }
    },
    ...
    fire_deflected_distorted: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 94, scope: "Section replacement or welding of structural steel reinforcing cover plates.", costDuration: "Premium | 5 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 75, scope: "Localized member strengthening and post-tensioned bracing systems.", costDuration: "Moderate | 3 Days" }
    },
    ...
    floor_settlement: {
        ...
        A: { title: "Advanced Structural Retrofitting", match: 91, scope: "Stabilize subgrade via polyurethane foam injection under-slab and inject cracks with semi-rigid epoxy.", costDuration: "Premium | 4 Days" },
        B: { title: "Cost-Effective Maintenance Repair", match: 75, scope: "Slab jacking via standard cement slurry injection and floor crack patching.", costDuration: "Moderate | 2 Days" }
    },
...
function initPostRecommendations() {
    const mockPostDefs = ['surface_voids_general', 'cold_joint_formwork', 'crack_shrinkage_thermal_crack', 'corrosion_lower_cover_rcc', 'flexural_crack_rcc', 'shear_crack_rcc', 'plaster_spalling', 'seepage_damage_waterproofing'];
...
$('rccGoToAnalysisBtn').addEventListener('click', () => {
    ...
    const mockAiDefs = ['seepage_rcc_no_corrosion', 'seepage_rcc_with_corrosion', 'seepage_damage_waterproofing', 'dry_dampness_rcc_no_corrosion', 'dry_dampness_rcc_with_corrosion', 'dampness_capillary', 'leakage_water_ingress_source', 'corrosion_minor'];
